...
from rap_web.config import Config, DevConfig, TestConfig
from rap_web.utils.build_info import get_build_info
from rap_web.utils.compiled_css_js_filenames import get_app_css_filename, get_app_js_filename
from rap_web.utils.http_basic_authentication import HttpBasicAuthentication
from rap_web.utils.maintenance_mode import Maintenance
from rap_web.utils.custom_error_handlers import CustomErrorHandlers
...
def create_app(test_config=None):
    ...
    # Home
    from rap_web.home import home
    app.register_blueprint(home)

    # Allow additional "/assets" URL for static assets
    from rap_web.assets import assets
