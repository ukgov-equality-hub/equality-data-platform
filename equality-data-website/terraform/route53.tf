...
data "aws_route53_zone" "equality_data_dot_service_dot_cabinet_office_dot_gov_dot_uk_zone" {
...
resource "aws_route53_record" "dns_alias_record" {
  ...
  zone_id = data.aws_route53_zone.equality_data_dot_service_dot_cabinet_office_dot_gov_dot_uk_zone.zone_id
  name    = "${var.dns_record_subdomain_including_dot}${data.aws_route53_zone.equality_data_dot_service_dot_cabinet_office_dot_gov_dot_uk_zone.name}"
  type    = "A"
